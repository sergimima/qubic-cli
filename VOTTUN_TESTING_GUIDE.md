...
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -vottunGetTotalReceivedTokens <AMOUNT>
```
**Example**:
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -vottunGetTotalReceivedTokens 1000000
```
...
### 1.5 Get Admin ID
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -vottunGetAdminID <ID_NUMBER>
```
**Example**:
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -vottunGetAdminID 0
```

---

### 1.6 Find order by details
```bash
...
### 3.3 Transfer to contract
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -seed <MANAGER_SEED> -scheduledTickOffset <OFFSET> -vottunTransferToContract <AMOUNT> <ORDER_ID>
```

**Example**:
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -seed "manager_seed" -scheduledTickOffset 10 -vottunTransferToContract 10000000 1
```
...
### 4.1 Set new admin
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -seed <ADMIN_SEED> -scheduledTickOffset <OFFSET> -vottunSetAdmin <NEW_ADMIN_IDENTITY>
```

**Example**:
```bash
./qubic-cli -nodeip 194.247.186.29 -nodeport 31841 -seed "admin_seed" -scheduledTickOffset 10 -vottunSetAdmin "NEW_ADMIN_IDENTITY"
```
