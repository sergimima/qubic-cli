...
enum COMMAND
{
    ...
    COMP_CHAT = 106,
    VOTTUNBRIDGE_GET_ORDER = 107,
    VOTTUNBRIDGE_GET_TOTAL_RECEIVED_TOKEN = 108,
    VOTTUNBRIDGE_GET_ADMIN_ID = 109,
    VOTTUNBRIDGE_GET_TOTAL_LOCKED_TOKEN = 110,
    VOTTUNBRIDGE_GET_ORDER_BY_DETAILS = 111,
    VOTTUNBRIDGE_CREATE_ORDER = 112,
    VOTTUNBRIDGE_SET_ADMIN = 113,
    VOTTUNBRIDGE_ADD_MANAGER = 114,
    VOTTUNBRIDGE_REMOVE_MANAGER = 115,
    VOTTUNBRIDGE_COMPLETE_ORDER = 116,
    VOTTUNBRIDGE_REFUND_ORDER = 117,
    VOTTUNBRIDGE_TRANSFER_TO_CONTRACT = 118,
    VOTTUNBRIDGE_ADD_LIQUIDITY = 119,
    VOTTUNBRIDGE_WITHDRAW_FEES = 120,
    VOTTUNBRIDGE_GET_CONTRACT_INFO = 121,
    VOTTUNBRIDGE_GET_AVAILABLE_FEES = 122,
    VOTTUNBRIDGE_CREATE_PROPOSAL = 123,
    VOTTUNBRIDGE_APPROVE_PROPOSAL = 124,
    VOTTUNBRIDGE_GET_PROPOSAL = 125,
