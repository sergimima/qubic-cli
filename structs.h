...
enum COMMAND
{
    ...
    VOTTUNBRIDGE_GET_TOTAL_LOCKED_TOKEN = 109,
    VOTTUNBRIDGE_GET_ORDER_BY_DETAILS = 110,
    VOTTUNBRIDGE_CREATE_ORDER = 111,
    VOTTUNBRIDGE_ADD_MANAGER = 112,
    VOTTUNBRIDGE_REMOVE_MANAGER = 113,
    VOTTUNBRIDGE_COMPLETE_ORDER = 114,
    VOTTUNBRIDGE_REFUND_ORDER = 115,
    VOTTUNBRIDGE_TRANSFER_TO_CONTRACT = 116,
    VOTTUNBRIDGE_ADD_LIQUIDITY = 117,
    VOTTUNBRIDGE_WITHDRAW_FEES = 118,
    VOTTUNBRIDGE_GET_CONTRACT_INFO = 119,
    VOTTUNBRIDGE_GET_AVAILABLE_FEES = 120,
    VOTTUNBRIDGE_CREATE_PROPOSAL = 121,
    VOTTUNBRIDGE_APPROVE_PROPOSAL = 122,
    VOTTUNBRIDGE_GET_PROPOSAL = 123,
